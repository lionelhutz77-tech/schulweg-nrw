...
// Vokabeltrainer (Unit 5, 50 echte Vokabeln) - Deutsch -> Englisch tippen.
window.SCHULWEG.faecher["englisch-6"].vokabeltrainer = [
  { de: "windig", en: "windy" },
  { de: "der Wind", en: "wind" },
  { de: "wolkig", en: "cloudy" },
  { de: "die Wolke", en: "cloud" },
  { de: "eiskalt", en: "freezing" },
  { de: "der Schnee", en: "snow" },
  { de: "verschneit / schneebedeckt", en: "snowy" },
  { de: "kühl", en: "cool" },
  { de: "der Grad (Temperatur)", en: "degree", alt: ["degrees"] },
  { de: "die Jahreszeit", en: "season" },
  { de: "der Frühling", en: "spring" },
  { de: "der Sommer", en: "summer" },
  { de: "der Herbst", en: "autumn", alt: ["fall"] },
  { de: "der Winter", en: "winter" },
  { de: "die Zukunft", en: "future" },
  { de: "der Zug", en: "train" },
  { de: "Fotos machen / fotografieren", en: "take photos", alt: ["take a photo", "take photo", "take a picture"] },
  { de: "langsam (wie? – Adverb)", en: "slowly" },
  { de: "schnell (wie? – Adverb)", en: "quickly" },
  { de: "geradeaus", en: "straight on", alt: ["straight ahead"] },
  { de: "nach vorn / vorwärts", en: "forward" },
  { de: "die Sicherheit", en: "safety" },
  { de: "der Kompass", en: "compass" },
  { de: "die Trillerpfeife", en: "whistle" },
  { de: "der Abfall / Müll", en: "litter" },
  { de: "der Mülleimer", en: "litter bin", alt: ["bin"] },
  { de: "die Brücke", en: "bridge" },
  { de: "der Stein", en: "stone" },
  { de: "die Polizei", en: "police" },
  { de: "verheiratet (mit)", en: "married", alt: ["married to"] },
  { de: "ledig / alleinstehend", en: "single" },
  { de: "minus", en: "minus" },
  { de: "das Häuschen / die Hütte", en: "cottage" },
  { de: "das Kreuz", en: "cross" },
  { de: "der Kilometer", en: "kilometre", alt: ["kilometer", "km"] },
  { de: "weit (entfernt)", en: "far" },
  { de: "langsam (Adjektiv)", en: "slow" },
  { de: "schnell (Adjektiv)", en: "quick" },
  { de: "aufmerksam / genau zuhören", en: "listen carefully" },
  { de: "ob / wenn, falls", en: "if" },
  { de: "der Schritt", en: "step" },
  { de: "das Plastik / der Kunststoff", en: "plastic" },
  { de: "der Erste-Hilfe-Kasten", en: "first-aid kit", alt: ["first aid kit"] },
  { de: "etwas anziehen / aufsetzen", en: "put on", alt: ["put sth on"] },
  { de: "etwas zurücklassen", en: "leave" },
  { de: "etwas aufheben (vom Boden)", en: "pick up", alt: ["pick sth up"] },
  { de: "am unteren Ende / unten", en: "at the bottom" },
  { de: "sie konnten", en: "they could" },
  { de: "(hin)gelangen / hinkommen", en: "get" },
  { de: "etwas gut können / gut sein in", en: "be good at", alt: ["good at"] }
];
