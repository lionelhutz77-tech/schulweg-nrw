...
window.SCHULWEG.faecher["englisch-6"].vokabeltrainer = [
  ...
  { de: "der See", en: "lake" },
  { de: "das Grillfest", en: "barbecue", alt: ["barbeque"] },
  { de: "umhergehen", en: "walk around" },
  { de: "das Wetter", en: "weather" },
  { de: "warm", en: "warm" },
  { de: "kalt", en: "cold" },
  { de: "sonnig", en: "sunny" },
  { de: "die Sonne", en: "sun" },
  { de: "regnerisch", en: "rainy" },
  ...
  { de: "der Unterricht", en: "class" },
  { de: "treffen", en: "meet" },
  { de: "bekommen", en: "get" },
  { de: "ziemlich", en: "quite" },
  { de: "allein", en: "alone" },
  { de: "lang", en: "long" },
  { de: "kurz", en: "short" },
  { de: "das Mitteilungsblatt", en: "newsletter" },
  { de: "die Mittagszeit", en: "lunchtime" },
  { de: "fit", en: "fit" },
  { de: "das Experiment", en: "experiment" },
  { de: "schauspielern", en: "act" },
  { de: "machen", en: "do" },
  { de: "Weihnachten", en: "Christmas" },
  { de: "das Theaterstück", en: "play" },
  { de: "gesund", en: "healthy" },
  { de: "lecker", en: "yummy", alt: ["delicious"] },
  { de: "der Ausflug", en: "trip" },
  { de: "das Projekt", en: "project" },
  { de: "herausfinden", en: "find out" },
  { de: "der Kreis", en: "circle" },
  { de: "der Kanal", en: "channel" },
  { de: "fahren", en: "drive" },
  { de: "Freunde finden", en: "make friends" },
  { de: "die Gegenwart", en: "present" },
  { de: "die Vergangenheit", en: "past" },
  { de: "fühlen", en: "feel" },
  { de: "die Regel", en: "rule" },
  { de: "der Satz", en: "sentence" },
  { de: "suchen", en: "look for" },
  { de: "schließlich", en: "in the end" },
  { de: "der Gewinner", en: "winner" },
  { de: "jeder", en: "each" },
  ...
  { de: "sehen", en: "see" },
  { de: "denken", en: "think" },
  { de: "ein paar", en: "a few" },
  { de: "ohne", en: "without" },
  { de: "antworten", en: "answer" },
  { de: "wenn", en: "when" },
  { de: "der Schulhof", en: "yard" },
  { de: "warten", en: "wait" },
  { de: "überrascht", en: "surprised" },
  { de: "traurig", en: "sad" },
  { de: "das Auge", en: "eye" },
  { de: "sterben", en: "die" },
  { de: "deshalb", en: "that's why" },
  { de: "weinen", en: "cry" },
  { de: "unfreundlich", en: "unfriendly" },
  { de: "sammeln", en: "collect" },
  { de: "das Gegenteil", en: "opposite" },
  { de: "der Tipp", en: "tip" },
  { de: "ungesund", en: "unhealthy" },
  { de: "uninteressant", en: "uninteresting" },
  { de: "unsicher", en: "unsure" },
  { de: "unerwünscht", en: "unwelcome" },
  { de: "seltsam", en: "strange" },
  { de: "tragen (Kleidung)", en: "wear" },
  { de: "der Schal", en: "scarf" },
  { de: "oje!", en: "Oh dear!" },
  { de: "wütend", en: "angry" },
  { de: "schüchtern", en: "shy" },
  { de: "der Nachbar", en: "neighbour", alt: ["neighbor"] },
  { de: "das Postamt", en: "post office" },
  { de: "die Werkstatt", en: "garage" },
  { de: "die Elektronik", en: "electronics" },
  { de: "die Gasse", en: "lane" },
  { de: "der Kuchen", en: "cake" },
  { de: "der Parkplatz", en: "car park", alt: ["carpark"] },
  { de: "das Haar", en: "hair" },
  { de: "der Zeitungshändler", en: "newsagent" },
  { de: "der Briefkasten", en: "letter box", alt: ["letterbox"] },
  { de: "der Friseur", en: "hairdresser" },
  { de: "die Landkarte", en: "map" },
  { de: "die Bushaltestelle", en: "bus stop" },
  { de: "die Ampel", en: "traffic lights" },
  { de: "die Blume", en: "flower" },
  { de: "die Nachbarschaft", en: "neighbourhood", alt: ["neighborhood"] },
  { de: "die Wurst", en: "sausage" },
  { de: "beliebt", en: "popular" },
  { de: "Großbritannien", en: "Great Britain" },
  { de: "die Milch", en: "milk" },
  { de: "das Brot", en: "bread" },
  { de: "das Halsband", en: "collar" },
  { de: "plötzlich", en: "suddenly" },
  { de: "der Feuerwerkskörper", en: "firework" },
  { de: "das Feuerwerk", en: "fireworks" },
  { de: "rennen", en: "run" },
  ...
  { de: "klingeln", en: "ring" },
  { de: "schicken", en: "send" },
  { de: "der Besitzer", en: "owner" },
  { de: "der Schwanz", en: "tail" },
  { de: "erzählen", en: "tell" },
  { de: "offen", en: "open" },
  { de: "nehmen", en: "take" },
  { de: "das Ohr", en: "ear" },
  { de: "adoptieren", en: "adopt" },
  { de: "ausgehen", en: "go out" },
  { de: "prüfen", en: "check" },
  { de: "spazieren gehen", en: "go for a walk" },
  { de: "der Wellensittich", en: "budgie" },
  { de: "das Freudenfeuer", en: "bonfire" },
  { de: "feiern", en: "celebrate" },
  { de: "das Kostüm", en: "costume" },
  { de: "die Kartoffel", en: "potato" },
  { de: "die Kleidung", en: "clothes" },
  { de: "der Kakao", en: "cocoa" },
  { de: "Neujahr", en: "New Year" },
  { de: "die Hexe", en: "witch" },
  { de: "das Geheimnis", en: "mystery" },
  { de: "jemand", en: "someone", alt: ["somebody"] },
  { de: "die Jacke", en: "jacket" },
  { de: "die Maske", en: "mask" },
  { de: "das Spielzeug", en: "toy" },
  { de: "das Publikum", en: "audience" },
  { de: "auswählen", en: "pick" },
  { de: "der Schauspieler", en: "actor" },
  { de: "deuten", en: "point" },
  { de: "aufschauen", en: "look up" },
  { de: "fast", en: "nearly" },
  { de: "albern", en: "silly" },
  { de: "flüstern", en: "whisper" },
  { de: "der Brieffreund", en: "penfriend" },
  { de: "mindestens", en: "at least" },
  { de: "die Wegbeschreibung", en: "directions" },
  { de: "überqueren", en: "cross" },
  { de: "rechts abbiegen", en: "turn right" },
  { de: "links abbiegen", en: "turn left" },
  { de: "der Meter", en: "metre", alt: ["meter"] },
  { de: "die Bank", en: "bank" },
  { de: "das Toilettenpapier", en: "toilet roll" },
  { de: "gruselig", en: "scary" },
  { de: "erschrecken", en: "scare" },
  { de: "perfekt", en: "perfect" },
  { de: "relaxen", en: "chill" },
  { de: "das Zeug", en: "stuff" },
  { de: "Ski fahren", en: "ski" },
  ...
  { de: "die Tasche", en: "pocket" },
  { de: "das Taschengeld", en: "pocket money" },
  { de: "geizig", en: "mean" },
  { de: "bis", en: "until" },
  { de: "staubsaugen", en: "hoover" },
  { de: "füllen", en: "fill" },
  { de: "der Geschirrspüler", en: "dishwasher" },
  { de: "leeren", en: "empty" },
  { de: "schneiden", en: "cut" },
  { de: "das Gras", en: "grass" },
  { de: "den Rasen mähen", en: "cut the grass" },
  { de: "aufräumen", en: "tidy" },
  { de: "bitten (um)", en: "ask for" },
  { de: "zum Beispiel", en: "for example" },
  { de: "die Vereinbarung", en: "arrangement" },
  { de: "der Plan", en: "plan" },
  { de: "Schlittschuhlaufen", en: "ice skating" },
  { de: "billig", en: "cheap" },
  { de: "immer noch", en: "still" },
  { de: "nächstes Mal", en: "next time" },
  { de: "der Handschuh", en: "glove" },
  { de: "die Brille", en: "glasses" },
  { de: "der Wettkampf", en: "match" },
  { de: "die Aktivität", en: "activity" },
  { de: "der Erwachsene", en: "adult" },
  { de: "kostenlos", en: "free" },
  { de: "vorsichtig", en: "careful" },
  { de: "Eishockey", en: "ice hockey" },
  { de: "die Erde", en: "earth" },
  { de: "der Zirkus", en: "circus" },
  { de: "der Hai", en: "shark" },
  ...
  { de: "loswerden", en: "get rid of" },
  { de: "wiederverwerten", en: "recycle" },
  { de: "öffnen", en: "open (verb)", alt: ["open"] },
  { de: "die Dartscheibe", en: "dartboard" },
  { de: "sparen", en: "save" },
  { de: "die Wand", en: "wall" },
  { de: "bequem", en: "comfortable" },
  { de: "der Pfeil", en: "dart" },
  { de: "das Kleid", en: "dress" },
  { de: "ankommen", en: "arrive" },
  { de: "die Aufgabe", en: "task" },
  { de: "der Vortrag", en: "talk" },
  { de: "zeigen", en: "show" },
  { de: "die Ausrüstung", en: "gear" },
  { de: "entspannend", en: "relaxing" },
  { de: "der Trainer", en: "coach" },
  { de: "die Komödie", en: "comedy" },
  { de: "die Krimiserie", en: "crime series" },
  { de: "die Serie", en: "series" },
  { de: "der Dokumentarfilm", en: "documentary" },
  { de: "die Seife", en: "soap" },
  { de: "die Realityshow", en: "reality show" },
  { de: "die Wirklichkeit", en: "reality" },
  { de: "am besten", en: "best" },
  { de: "stimmen (für)", en: "vote" },
  { de: "der Anführer", en: "leader" },
  { de: "der Kartenschalter", en: "ticket office" },
  { de: "weniger", en: "less" },
  { de: "ungesundes Essen", en: "junk food" },
  { de: "die Chips", en: "crisps" },
  { de: "meistens", en: "mostly" },
  { de: "zuckerhaltig", en: "sugary" },
  { de: "der Zucker", en: "sugar" },
  { de: "Zeit verbringen", en: "spend time" },
  { de: "Geld ausgeben", en: "spend money" },
  { de: "aktiv", en: "active" },
  { de: "der Rat", en: "advice" },
  { de: "zustimmen", en: "agree" },
  { de: "die Hand", en: "hand" },
  { de: "der Rücken", en: "back" },
  { de: "der Arm", en: "arm" },
  { de: "die Faust", en: "fist" },
  { de: "das Knie", en: "knee" },
  { de: "natürlich", en: "of course" },
  { de: "die Ofenkartoffel", en: "baked potato" },
  { de: "der Nachtisch", en: "dessert" },
  { de: "die Pastete", en: "pasty" },
  { de: "das Fleisch", en: "meat" },
  { de: "vorher", en: "before" },
  { de: "die Brotdose", en: "lunch box" },
  { de: "die Karotte", en: "carrot" },
  { de: "der Orangensaft", en: "orange juice" },
  { de: "die Orange", en: "orange" },
  { de: "die Salami", en: "salami" },
  { de: "der Arzt", en: "doctor" },
  { de: "dunkel", en: "dark" },
  { de: "die Erdnussbutter", en: "peanut butter" },
  { de: "die Frühstücksflocken", en: "cereals" },
  { de: "der Smoothie", en: "smoothie" },
  { de: "keiner", en: "none" },
  { de: "genug", en: "enough" },
  { de: "schwänzen", en: "skive" },
  { de: "krank", en: "ill" },
  { de: "Magenschmerzen", en: "stomach ache", alt: ["stomachache"] },
  { de: "Kopfschmerzen", en: "headache" },
  { de: "verlieren", en: "lose" },
  { de: "umziehen", en: "move" },
  { de: "Halsschmerzen", en: "a sore throat", alt: ["sore throat"] },
  { de: "der Hals", en: "throat" },
  { de: "die Erkältung", en: "cold" },
  { de: "die Temperatur", en: "temperature" },
  { de: "der Schlaf", en: "sleep" },
  { de: "der Termin", en: "appointment" },
  { de: "aufhören", en: "stop" },
  { de: "frisch", en: "fresh" },
  { de: "die Luft", en: "air" },
  { de: "gerade", en: "just" },
  { de: "verpassen", en: "miss" },
  { de: "noch nicht", en: "not yet" },
  { de: "schon", en: "already" },
  { de: "durstig", en: "thirsty", alt: ["be thirsty"] },
  { de: "sauer", en: "cross" },
  { de: "alles", en: "everything" },
  { de: "das Stadion", en: "stadium" },
  { de: "enttäuscht", en: "disappointed" },
  { de: "das Kätzchen", en: "kitten" },
  { de: "der Anruf", en: "phone call" },
  { de: "positiv", en: "positive" },
  { de: "der Chat", en: "chat" },
  { de: "ändern", en: "change" },
  { de: "der Witz", en: "joke" },
  { de: "lächeln", en: "smile" },
  { de: "groß (Person)", en: "tall" },
  { de: "klein (Person)", en: "short" },
  { de: "sportlich", en: "sporty" },
  { de: "schlau", en: "clever" },
  { de: "der Typ", en: "guy" },
  { de: "gelassen", en: "easy-going" },
  { de: "besonders", en: "especially" },
  { de: "vorziehen", en: "prefer" },
  { de: "das Thema", en: "subject" },
  { de: "die Nachricht", en: "message" },
  { de: "sich freuen auf", en: "look forward to" },
  { de: "klettern", en: "climb" },
  { de: "Judo", en: "judo" },
  { de: "die Gymnastik", en: "gymnastics" },
  { de: "Bogenschießen", en: "archery" },
  { de: "tauchen", en: "dive" },
  { de: "genießen", en: "enjoy" },
  { de: "verlegen", en: "embarrassed" },
  { de: "der Schlamm", en: "mud" },
  { de: "der Nationalpark", en: "national park" },
  { de: "der Südwesten", en: "south-west" },
  { de: "der Süden", en: "south" },
  { de: "der Westen", en: "west" },
  { de: "der Norden", en: "north" },
  { de: "der Osten", en: "east" },
  { de: "der Südosten", en: "south-east" },
  { de: "der Nordosten", en: "north-east" },
  { de: "der Nordwesten", en: "north-west" },
  { de: "der Tourist", en: "tourist" },
  { de: "der Fluss", en: "river" },
  { de: "überall", en: "everywhere" },
  { de: "beißen", en: "bite" },
  { de: "sein", en: "be" },
  { de: "der Fuchs", en: "fox" },
  { de: "früher", en: "in the old days" },
  { de: "riechen", en: "smell" },
  { de: "die Wettervorhersage", en: "forecast" },
  { de: "neblig", en: "foggy" },
  { de: "der Nebel", en: "fog" },
  { de: "der Stiefel", en: "boot" },
  { de: "die Wanderstiefel", en: "walking boots" },
  { de: "das Zelt", en: "tent" },
  { de: "packen", en: "pack" },
  { de: "der Schlafanzug", en: "pyjamas" },
  { de: "der Föhn", en: "hairdryer" },
  { de: "der Rucksack", en: "rucksack" },
  { de: "die Jeans", en: "jeans" },
  { de: "die Liste", en: "list" },
  { de: "ob", en: "if" },
  { de: "der Schritt", en: "step" },
  { de: "vorwärts", en: "forward" },
  { de: "geradeaus", en: "straight on" },
  { de: "die Sicherheit", en: "safety" },
  { de: "der Kompass", en: "compass" },
  { de: "die Pfeife", en: "whistle" },
  { de: "das Plastik", en: "plastic" },
  { de: "der Erste-Hilfe-Kasten", en: "first aid kit" },
  { de: "die Wolke", en: "cloud" },
  { de: "wolkig", en: "cloudy" },
  { de: "anziehen", en: "put on" },
  { de: "zurücklassen", en: "leave" },
  { de: "der Abfall", en: "litter" },
  { de: "der Mülleimer", en: "litter bin" },
  { de: "aufheben", en: "pick up" },
  ...
  { de: "windig", en: "windy" },
  { de: "der Wind", en: "wind" },
  { de: "verschneit", en: "snowy" },
  { de: "der Schnee", en: "snow" },
  { de: "eiskalt", en: "freezing" },
  { de: "minus", en: "minus" },
  { de: "der Stein", en: "stone" },
  { de: "die Brücke", en: "bridge" },
  { de: "die Hütte", en: "cottage" },
  { de: "das Kreuz", en: "cross (noun)", alt: ["cross"] },
  { de: "der Kilometer", en: "kilometre", alt: ["kilometer"] },
  { de: "fotografieren", en: "take photos" },
  { de: "weit", en: "far" },
  { de: "gelangen", en: "get to" },
  { de: "der Boden", en: "ground" },
  { de: "der Fels", en: "rock" },
  { de: "rund", en: "round" },
  { de: "schreien", en: "scream" },
  { de: "rufen", en: "shout" },
  { de: "die Stimme", en: "voice" },
  { de: "der Bahnhof", en: "station" },
  { de: "der Bahnsteig", en: "platform" },
  { de: "der Fahrgast", en: "passenger" },
  { de: "pünktlich", en: "on time" },
  { de: "abfahren", en: "leave (train)" },
  { de: "der Krankenwagen", en: "ambulance" },
  { de: "der Notfall", en: "emergency" },
  { de: "der Rettungsdienst", en: "emergency services" },
  { de: "der Unfall", en: "accident" },
  { de: "die Meile", en: "mile" },
  { de: "verletzt", en: "hurt" },
  { de: "verletzen", en: "injure", alt: ["hurt"] },
  { de: "korrigieren", en: "correct" },
  { de: "die Postkarte", en: "postcard" },
  { de: "der Buchstabe", en: "letter" },
  { de: "der Großbuchstabe", en: "capital letter" },
  { de: "der Fehler", en: "mistake" },
  { de: "die Sorte", en: "kind of", alt: ["kind"] },
  { de: "der Stempel", en: "stamp" },
  { de: "die Flagge", en: "flag" },
  { de: "die Reise", en: "journey" },
  { de: "der Pilger", en: "pilgrim" },
  { de: "verlassen", en: "leave" },
  { de: "das Schiff", en: "ship" },
  { de: "segeln", en: "sail" },
  { de: "berühmt", en: "famous" },
  { de: "der Seemann", en: "sailor" },
  { de: "kämpfen", en: "fight" },
  { de: "gegen", en: "against" },
  { de: "der Schmuggler", en: "smuggler" },
  { de: "die Küste", en: "coast" },
  { de: "der König", en: "king" },
  { de: "die Legende", en: "legend" },
  { de: "ziehen", en: "pull" },
  { de: "das Schwert", en: "sword" },
  { de: "werden", en: "become" },
  { de: "der Zauberer", en: "magician" },
  { de: "das Lager", en: "camp" },
  { de: "die Fantasie", en: "fantasy" },
  { de: "die Burg", en: "castle" },
  { de: "die Treppe", en: "stairs" },
  { de: "eintreten", en: "enter" },
  { de: "der Gang", en: "hall" },
  { de: "die Magie", en: "magic" },
  { de: "erstaunlich", en: "amazing" },
  { de: "bis jetzt", en: "so far" },
  { de: "stehen", en: "stand" },
  { de: "der Kapitän", en: "captain" },
  { de: "die Fahrkarte", en: "ticket" },
  { de: "die Kutsche", en: "carriage" },
  { de: "das Pferd", en: "horse" },
  { de: "einschalten", en: "switch on" },
  { de: "ausschalten", en: "switch off" },
  { de: "das Licht", en: "lights", alt: ["light"] },
  { de: "die Information", en: "information" },
  { de: "zerstören", en: "destroy" },
  { de: "die Ruine", en: "ruins" },
  { de: "die Höhle", en: "cave" },
  { de: "bauen", en: "build" },
  { de: "die Stufe", en: "step (stair)" },
  { de: "bürsten", en: "brush" },
  { de: "die Bürste", en: "brush (noun)" },
  { de: "werfen", en: "throw" },
